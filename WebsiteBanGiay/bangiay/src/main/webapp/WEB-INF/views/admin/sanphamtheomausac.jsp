                        ...
                        <div class="row">
                          <div class="col-md-12">
                                ...
                                <div class="table-responsive table-responsive-data2">
                                 ...
                                 <h2 style="float:right"><mytag1:ClassPaginationTag1 max="10" offset="${offset}" count="${count}" uri="/bangiay/admin/sanphammausac?mauSacId=${maMauSac}&" next="&raquo;" previous="&laquo;"/></h2>
                                </div>
                            </div>
