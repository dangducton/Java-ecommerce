											...
											<div class="row form-group">
												...
												<div class="col-12 col-md-9">
													<input type="text" name="tensanpham"
														placeholder="Nhập tên sản phâm" class="form-control" /> 
