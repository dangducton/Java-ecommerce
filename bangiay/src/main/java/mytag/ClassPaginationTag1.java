...
public class ClassPaginationTag1 extends SimpleTagSupport {
    ...
    public void doTag() throws JspException {
        ...
        try {
            ...
            for (int itr = 0; itr < count; itr += steps) {
                if (offset == itr) {
                    out.write(constructLink((itr / 12 + 1) - 1 * steps, String.valueOf(itr / 12 + 1), "active", true));
                } else {
                    out.write(constructLink(itr / 12 * steps, String.valueOf(itr / 12 + 1), null, false));
                }
            }
