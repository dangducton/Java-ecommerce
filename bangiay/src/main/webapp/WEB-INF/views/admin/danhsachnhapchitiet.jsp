                          ...
                          <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                   ...
                                   <div class="table-data__tool-right">
                                        <a href="/bangiay/admin/tongnhapchitiet">
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            <i class="zmdi zmdi-plus"></i>Tổng nhập chi tiết </button>
                                            </a>
                                    </div>
                                    ...
                                    <table class="table table-data2">
                                        ...
                                        <c:forEach items="${listNhap}" var="listNhap" varStatus="itr">
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="desc">${listNhap.idsanpham.iddanhmuc.tendanhmuc}</td>
                                                <td class="desc">${listNhap.idsanpham.tensanpham}</td>
                                                <td><img src="<c:url value="/files/${listNhap.idsanpham.image1}"/>" height='150' width='150' alt=""></td>
                                                <td class="desc"><b style="color: black">${listNhap.idsanpham.idmausanpham.tenmau}</b></td>
                                                <td class="desc"><b style="color: black">${listNhap.idsize.tensize}</b></td>
                                                <td class="desc"><b style="color: black">${listNhap.soluong}</b></td>
                                                 <td>
                                                   <div class="table-data-feature">
                                                    <button class="item" data-toggle="tooltip" data-placement="top" title="Sửa">
                                                            <a href="/bangiay/admin/updateNhapChiTiet?nhapId=${listNhap.idnhapchitiet}"><i class="zmdi zmdi-edit"></i></a>
                                                            </button>
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Xóa">
                                                            <a href="/bangiay/admin/deleteNhapChiTiet?nhapId=${listNhap.idnhapchitiet}"><i class="zmdi zmdi-delete"></i></a>
                                                            </button>
                                                    </div>
                                                    </td>
                                            </tr>
